...
export default function EmployeeListPage() {
  ...
  // ============================================
  // FILTRADO: Búsqueda + Departamento
  // ============================================
  // useMemo optimiza: solo recalcula cuando cambian users, searchQuery o selectedDepartmentId
  ...
  // ============================================
  // FUNCIONES: Manejo de eliminación
  // ============================================
  ...
  return (
    <main className="space-y-6">
      ...
      <Card padding={true}>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg bg-light-background border border-gray-stroke text-cohispania-blue focus:ring-2 focus:ring-cohispania-blue focus:border-cohispania-blue outline-none transition"
            >
        ...
        {/* Cards Mobile */}
        {!loading?.users && !error && filteredUsers.length > 0 && (
