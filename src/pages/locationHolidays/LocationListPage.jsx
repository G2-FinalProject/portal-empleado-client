...
export default function LocationListPage() {
  ...
  const deleteLocation = useAdminStore((state) => state.deleteLocation);
              ...
              <div className="hidden md:block overflow-hidden rounded-lg border border-gray-stroke">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-stroke bg-white">
                    {filtered.map(
                      (
                        location // ✅ CORREGIDO: filtered en lugar de filteredLocations
                      ) => (
                        <tr
                          key={location.id}
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-red-400">
            ⚠️ Esta acción no se puede deshacer. La población y todos sus
            festivos serán eliminados permanentemente del sistema.
          </p>
