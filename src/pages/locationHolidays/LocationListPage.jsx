  ...
  return (
    <main className="p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-cohispania-blue">
            Festivos Poblaciones
          </h1>
          <p className="text-sm text-slate-500">
            Gestiona las poblaciones configuradas
          </p>
        </div>

        <Link
          to="/locations/create"
          className="rounded-xl px-4 py-2 border bg-white shadow-sm hover:bg-slate-50"
        >
          + Nueva Población
        </Link>
      </div>
